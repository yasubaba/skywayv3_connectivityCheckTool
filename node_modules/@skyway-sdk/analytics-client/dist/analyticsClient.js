...
class AnalyticsClient {
    constructor({ token, sdkVersion, contextId }, options) {
        ...
        this._acknowledgeCancelCallbacks = new Map();
        // eventIdごとのACK timeout。ACK/timeout/disposeのいずれでも必ずclearする。
        this._acknowledgeTimeouts = new Map();
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const analyticsLoggingServerDomain = this._options.analyticsLoggingServerDomain ||
    ...
    filterStatsReport(report) {
         ...
         */
        const connectedTransport = Array.from(report.values()).find((rtcStatsReportValue) => rtcStatsReportValue.type === 'transport' &&
        ...
        if (connectedTransport) {
            ...
            const nominatedCandidatePair = Array.from(report.values()).find((rtcStatsReportValue) => rtcStatsReportValue.type === 'candidate-pair' &&
                ...
                rtcStatsReportValue.id ===
                    (connectedTransport === null || connectedTransport === void 0 ? void 0 : connectedTransport.selectedCandidatePairId));
    ...
    _sendClientEvent(clientEvent) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                const executeAsync = () => __awaiter(this, void 0, void 0, function* () {
                    const backoff = new backoff_1.BackOff({ times: 6, interval: 500, jitter: 100 });
                    for (; !backoff.exceeded;) {
                        this._setAcknowledgeTimeout(clientEvent.id, () => {
                            if (this._socket === undefined) {
                                this._cancelAcknowledgeWait(clientEvent.id, new Error('Socket closed when trying to resend'));
                                return;
                            }
                            else {
                                this._socket.resendAfterReconnect(clientEvent);
                            }
                            this._cancelAcknowledgeWait(clientEvent.id, new Error('Timeout to send data'));
                            return;
                        });
                        ...
                        if (this._socket) {
                            ...
                            this._cancelAcknowledgeWait(clientEvent.id, new Error('Socket is undefined'));
                            this._clearAcknowledgeTimeout(clientEvent.id);
