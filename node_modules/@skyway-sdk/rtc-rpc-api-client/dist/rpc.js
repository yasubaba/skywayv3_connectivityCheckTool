...
class RPC {
    constructor() {
        ...
        this._disposerManager = new common_1.EventDisposer();
    ...
    _withEventDisposer(task) {
        const disposer = new common_1.EventDisposer();
        let disposed = false;
        const dispose = () => {
            disposed = true;
            disposer.dispose();
    ...
    request(method, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const createClosedWhileRequestingError = () => (0, util_1.createError)({
                    operationName: 'RPC.request',
                    info: errors_1.errors.onClosedWhileRequesting,
                    path: log.prefix,
                    payload: { method, params },
                });
                const handleMessage = (disposer) => __awaiter(this, void 0, void 0, function* () {
                    return (yield this._onMessage
                        .watch((msg) => msg.id === request.id, const_1.rpcTimeout, disposer)
                        .catch(() => {
                        throw (0, util_1.createError)({
                            operationName: 'RPC.request',
                ...
                const pendingRequest = () => __awaiter(this, void 0, void 0, function* () {
                    return this._withEventDisposer((disposer, isDisposed) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const message = yield Promise.race([
                            ...
                            this.onClosed.asPromise(const_1.rpcTimeout + 100, disposer).then(() => {
                                if (isDisposed()) {
                                    return neverDone();
                                }
                            ...
                            this.onFatalError
                                .asPromise(const_1.rpcTimeout + 100, disposer)
                                .then((e) => {
                                if (isDisposed()) {
                                    return neverDone();
                                }
                ...
                if (!this._reconnecting) {
                    ...
                    message = yield this._withEventDisposer((disposer, isDisposed) => Promise.race([
                        handleMessage(disposer),
                        // 返信待ち中に接続が切れた場合
                        (() => __awaiter(this, void 0, void 0, function* () {
                            yield this.onDisconnected.asPromise(const_1.rpcTimeout + 100, disposer);
                            if (isDisposed()) {
                                return neverDone();
                            }
                            try {
