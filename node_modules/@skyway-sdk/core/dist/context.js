...
const createForDevelopmentAuthTokenString_1 = require("./auth/createForDevelopmentAuthTokenString");
...
class SkyWayContext {
     ...
     */
    static CreateForDevelopment(appId, secretKey, configOptions = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const warningPayload = (0, util_1.createWarnPayload)({
                operationName: 'SkyWayContext.CreateForDevelopment',
                detail: 'To prevent leakage of authentication information, please refrain from using this method in release versions of your app.',
                payload: { appId },
            });
            console.warn('SkyWayContext.CreateForDevelopment', warningPayload);
            const tokenString = (0, createForDevelopmentAuthTokenString_1.createForDevelopmentAuthTokenString)({
                appId,
                secretKey,
            });
            const context = yield SkyWayContext.Create(tokenString, configOptions);
            const autoUpdateAuthToken = () => __awaiter(this, void 0, void 0, function* () {
                const newTokenString = (0, createForDevelopmentAuthTokenString_1.createForDevelopmentAuthTokenString)({
                    appId,
                    secretKey,
                });
                try {
                    yield context.updateAuthToken(newTokenString);
                }
                catch (error) {
                    log.warn('[failed] SkyWayContext.CreateForDevelopment.autoUpdateAuthToken', {
                        detail: error,
                        appId,
                    });
                }
            });
            const { removeListener } = context.onTokenUpdateReminder.add(() => __awaiter(this, void 0, void 0, function* () {
                yield autoUpdateAuthToken();
            }));
