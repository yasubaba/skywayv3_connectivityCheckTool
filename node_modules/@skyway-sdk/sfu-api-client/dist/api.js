...
class SFURestApiClient {
    ...
    startForwarding({ botId, publicationId, maxSubscribers, contentType, publisherId, forceTCP, }) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    createConsumer({ botId, forwardingId, rtpCapabilities, subscriptionId, subscriberId, spatialLayer, originPublicationId, forceTCP, }) {
        return __awaiter(this, void 0, void 0, function* () {
