...
class RtcApiImpl {
    constructor(_client) {
        ...
        this.onReconnectStart = new common_1.Event();
        this.onReconnectSuccess = new common_1.Event();
    ...
    _commonError(method, code, detail) {
        ...
        switch (code) {
            ...
            case 4030:
                ...
                if (((_c = (_b = (_a = detail === null || detail === void 0 ? void 0 : detail.info) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.code) === 403000) {
                    return (0, util_1.createError)({
                        operationName: method,
                ...
                switch ((_c = info === null || info === void 0 ? void 0 : info.error) === null || _c === void 0 ? void 0 : _c.code) {
                    ...
                    case 4030:
                        throw (0, util_1.createError)({
                            ...
                            path: log.prefix,
                            info: errors_1.errors.membersPerRoomLimitExceeded,
                            error: e,
                        });
                    case 404:
                        throw (0, util_1.createError)({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const { publicationId } = yield this._client
                ...
                switch ((_c = info === null || info === void 0 ? void 0 : info.error) === null || _c === void 0 ? void 0 : _c.code) {
                    case 403:
                    case 4030:
                        switch ((_e = (_d = info === null || info === void 0 ? void 0 : info.error) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.code) {
                            case 403002:
                                throw (0, util_1.createError)({
                                    operationName: 'RtcApiImpl.publish',
                                    path: log.prefix,
                                    info: errors_1.errors.publicationsPerRoomLimitExceeded,
                                    error: e,
                                });
                            case 403004:
                                throw (0, util_1.createError)({
                                    operationName: 'RtcApiImpl.publish',
                                    path: log.prefix,
                                    info: errors_1.errors.publicationsPerMemberLimitExceeded,
                                    error: e,
                                });
                            default:
                                throw (0, util_1.createError)({
                        ...
                        switch ((_e = (_d = info === null || info === void 0 ? void 0 : info.error) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.code) {
                            case 403003:
                                throw (0, util_1.createError)({
                                    ...
                                    path: log.prefix,
                                    info: errors_1.errors.subscriptionsPerRoomLimitExceeded,
                                    error: e,
                                });
                            case 403006:
                                throw (0, util_1.createError)({
                                    operationName: 'RtcApiImpl.subscribeStream',
                                    path: log.prefix,
                                    info: errors_1.errors.subscriptionsPerMemberLimitExceeded,
                                    error: e,
                                });
                            default:
                                throw (0, util_1.createError)({
