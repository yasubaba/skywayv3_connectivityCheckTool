export declare const errors: {
    ...
    readonly membersPerRoomLimitExceeded: {
        readonly name: "membersPerRoomLimitExceeded";
        readonly detail: "1Room内に作成できるMember上限数を超えています";
        readonly solution: "他のMemberがleaveした後に再度joinしてください。";
    };
    readonly publicationsPerRoomLimitExceeded: {
        readonly name: "publicationsPerRoomLimitExceeded";
        readonly detail: "1Room内に作成できるPublication上限数を超えています";
        readonly solution: "不要なPublicationを削除してから再度publishしてください。";
    };
    readonly publicationsPerMemberLimitExceeded: {
        readonly name: "publicationsPerMemberLimitExceeded";
        readonly detail: "1Memberが作成できるPublication上限数を超えています";
        readonly solution: "不要なPublicationを削除してから再度publishしてください。";
    };
    readonly subscriptionsPerRoomLimitExceeded: {
        readonly name: "subscriptionsPerRoomLimitExceeded";
        readonly detail: "1Room内に作成できるSubscription上限数を超えています";
        readonly solution: "不要なSubscriptionを削除してから再度subscribeしてください。";
    };
    readonly subscriptionsPerMemberLimitExceeded: {
        readonly name: "subscriptionsPerMemberLimitExceeded";
        readonly detail: "1Memberが作成できるSubscription上限数を超えています";
        readonly solution: "不要なSubscriptionを削除してから再度subscribeしてください。";
    };
